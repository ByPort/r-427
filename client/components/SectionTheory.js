        ...
        return (
            <div>
                ...
                <div className="greater">
                    ...
                    <ul>
                    <li>подраздел «Назначение и состав» предназначен для ознакомления с назначением АТС Бета с основными её составными частями.</li>
                    <li>подраздел «Тактико-технические данные предназначен для ознакомления с тактико-техническими характеристиками АТС Бета.</li>
                    <li>подраздел «Описание конструкции» предназначен для ознакомления с логической структурой АТС Бета.</li>
                    <li>подраздел «Программное обеспечание» предназначен для ознакомления с архитектурой программной настройки АТС Бета.</li>
