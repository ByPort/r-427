    ...
    render() {
        return (
            <div>
                ...
                <p>9. Основные типовые неисправности:</p>

<p>9.1. При наборе номера автоинформатор воспроизводит фразу <strong>«Неправильно набран номер»</strong>:</p>
...
<p>9.2. При наборе номера автоинформатор воспроизводит фразу <strong>«На данном направлении перегрузка»</strong>:</p>
...
<p>9.3. После набора внешнего номера (сигнализация <strong>1ВСК</strong>) происходит сброс, при этом набираемый абонент заведомо свободен. Для анализа причины необходимо включить опрос соединительных линий (пункт <strong>3.14</strong>. настоящего руководства) и набрать внешний номер.</p>

<p>9.3.1. В случае, когда соединительная линия занимается, но трансляции номера не происходит, возможны следующие неисправности:</p>
