        ...
        return (
            <div>
                ...
                <div className="greater">
                    ...
                    <li>
                    «БЛОК 2» разработан для перехода к разделу теории, где обучаемый сможет ознакомиться с основными тактико-техническими данными АТС Бета, основными комплектующими с подробным описанием каждого элемента входящего в состав автоматической телефонной станции.
                    </li>
                    <li>
