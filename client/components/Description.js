...
class Description extends React.Component {
    ...
    render() {
        return (
            ...
            <span style={{color: 'red'}}> АТС «Бета-128.11»</span> - это программно управляемая коммутационная система, имеющая дело только с цифровыми потоками. Аналоговые сигналы тоже могут коммутироваться цифровой станцией, но лишь с применением аналого-цифровых (A/D) и цифро-аналоговых (D/A) преобразователей. Это означает, что при входе в АТС аналоговый сигнал с абонентской линии тут же преобразуется в цифровую форму и дальше передаётся по каналам внутри АТС и телефонной сети именно в цифровом виде, превращаясь снова в аналоговый только перед попаданием в абонентскую линию другого абонента. На рис.1 представлена упрощённая базовая модель цифровой АТС.<br/><br/>
